# 🎨 Known Colors Index — TypeScript

Discord Display Name Styles require color representations in **24-bit decimal integer format**, rather than standard hex strings (e.g. `"#FF00FF"`). This document maps color options to their decimal values and details how translation functions work in TypeScript.
...
You can integrate these helpers directly inside your TypeScript handlers or utilities to safely convert on-the-fly:
