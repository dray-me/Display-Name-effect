# 🎨 Display Effects Catalog — TypeScript
...
- **Example**:
  ```json
  { "font_id": 11, "effect_id": 1, "colors": [16777215] }
  ```
...
- **Example**:
  ```json
  { "font_id": 7, "effect_id": 2, "colors": [5865, 16777215] }
  ```
...
- **Example**:
  ```json
  { "font_id": 10, "effect_id": 3, "colors": [16777215] }
  ```
...
- **Example**:
  ```json
  { "font_id": 3, "effect_id": 4, "colors": [16777215] }
  ```
...
- **Example**:
  ```json
  { "font_id": 8, "effect_id": 5, "colors": [8388736] }
  ```
...
- **Example**:
  ```json
  { "font_id": 1, "effect_id": 6, "colors": [16711935, 8388736] }
  ```
