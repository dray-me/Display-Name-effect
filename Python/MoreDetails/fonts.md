# 🔤 Known Fonts Reference Guide — Python

This file catalogs every known typography style currently configured inside the **Discord Display Name Styles** service. It serves as a definitive reference mapping for styling presets in Python profiles.
...
- **Example Usage**: `style = {"font_id": 1, "effect_id": 1, "colors": [16711935]}`
...
- **Example Usage**: `style = {"font_id": 2, "effect_id": 1, "colors": [16777215]}`
...
- **Example Usage**: `style = {"font_id": 3, "effect_id": 4, "colors": [16777215]}` (Often paired with Toon style).
...
- **Example Usage**: `style = {"font_id": 4, "effect_id": 6, "colors": [16777215]}`
...
- **Example Usage**: `style = {"font_id": 5, "effect_id": 1, "colors": [16777215]}`
...
- **Example Usage**: `style = {"font_id": 6, "effect_id": 3, "colors": [5865]}`
...
- **Example Usage**: `style = {"font_id": 7, "effect_id": 2, "colors": [5865, 16777215]}` (Stellar with color gradients).
...
- **Example Usage**: `style = {"font_id": 8, "effect_id": 5, "colors": [8388736]}`
...
- **Example Usage**: `style = {"font_id": 9, "effect_id": 3, "colors": [16711935]}` (Pink neon).
...
- **Example Usage**: `style = {"font_id": 10, "effect_id": 3, "colors": [16777215]}` (Original flagship Hedwig lookup style).
...
- **Example Usage**: `style = {"font_id": 11, "effect_id": 1, "colors": [16777215]}`
...
- **Example Usage**: `style = {"font_id": 12, "effect_id": 1, "colors": [5865]}`
- **Compatibility Status**: High.
